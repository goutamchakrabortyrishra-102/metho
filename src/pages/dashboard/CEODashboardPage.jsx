  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <Link to="/app/crm/leads?status=APPLICATION" className="bg-white rounded-xl border border-border p-4 hover:bg-emerald-50"><p className="text-xs uppercase text-slate-500">Registration started</p><p className="text-2xl font-bold text-emerald-800">{data.whatsapp_registration_started || 0}</p></Link>
        <Link to="/app/crm/leads?status=APPROVED" className="bg-white rounded-xl border border-border p-4 hover:bg-emerald-50"><p className="text-xs uppercase text-slate-500">Registration completed</p><p className="text-2xl font-bold text-emerald-800">{data.whatsapp_registration_completed || 0}</p></Link>
        <Link to="/app/crm/whatsapp" className="bg-white rounded-xl border border-border p-4 hover:bg-emerald-50"><p className="text-xs uppercase text-slate-500">Executive handoff</p><p className="text-2xl font-bold text-amber-600">{data.whatsapp_human_handoffs || 0}</p></Link>
        <Link to="/app/crm/whatsapp" className="bg-white rounded-xl border border-border p-4 hover:bg-red-50"><p className="text-xs uppercase text-slate-500">No reply after reminders</p><p className="text-2xl font-bold text-red-600">{data.whatsapp_no_response_after_reminders || 0}</p></Link>
      </div>
