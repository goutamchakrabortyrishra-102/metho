          ...
          >
            <div className="md:col-span-2 grid gap-3">
              ...
              <BrandingImageUpload
                ...
                hint="Homepage hero-এর ডানপাশের image (recommended 1200×900)।"
                value={form.landing_hero_image_url}
                onChange={setF("landing_hero_image_url")}
              ...
              <BrandingImageUpload
                ...
                label="Directory Hero Image"
                hint="Explore Partners page-এর background/overlay image।"
                value={form.directory_hero_image_url}
                onChange={setF("directory_hero_image_url")}
              ...
              <BrandingImageUpload
                ...
                hint="Product-এ image না দিলে এই fallback image দেখাবে।"
                value={form.product_placeholder_image_url}
                onChange={setF("product_placeholder_image_url")}
