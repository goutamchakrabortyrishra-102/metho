...
const links = [
  ...
  { to: "/admin/members", icon: Users, label: "Members", testId: "admin-nav-members", section: "Members & Rewards" },
  ...
  { to: "/admin/metho-store-admin", icon: Warehouse, label: "Store Owner Admin", testId: "admin-nav-metho-store-admin", section: "Commerce" },
  ...
  { to: "/admin/products", icon: Package, label: "Products", testId: "admin-nav-products" },
  ...
  { to: "/admin/pending-payments", icon: BadgeIndianRupee, label: "Pending Payments", testId: "admin-nav-pending-payments", section: "Finance" },
  ...
  { to: "/admin/transport-bookings", icon: CarTaxiFront, label: "Transport Bookings", testId: "admin-nav-transport-bookings", section: "Services & Logistics" },
  ...
  { to: "/admin/product-upload", icon: Upload, label: "Image Upload", testId: "admin-nav-product-upload", section: "System & Configuration" },
