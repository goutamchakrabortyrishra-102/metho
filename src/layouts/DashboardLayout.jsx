...
const links = [
  ...
  { to: "/app/company-inventory", icon: Boxes, label: "METHO Products Inventory", testId: "nav-company-inventory", adminOnly: true, section: "Inventory" },
  { to: "/app/metho-vegetable-inventory", icon: Package, label: "METHO Vegetable Inventory", testId: "nav-metho-vegetable-inventory", adminOnly: true },
