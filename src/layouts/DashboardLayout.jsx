...
import { LayoutDashboard, Wallet, Users, Network, Package, ShoppingCart, TrendingUp, User, LogOut, Menu, X, Search, Settings, Sparkles, BadgeIndianRupee, Calculator, Shield, Store, Compass, Trophy, Send, CheckCircle2, Upload, Bot, ClipboardList, Activity, Warehouse, BookOpenCheck, CarTaxiFront, UtensilsCrossed, Building2, BriefcaseBusiness, Trash2, Boxes, Plane } from "lucide-react";
...
const links = [
  ...
  { to: "/app/service-sectors", icon: BriefcaseBusiness, label: "Courier & Creative Services", testId: "nav-service-sectors", adminOnly: true },
